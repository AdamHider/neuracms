...
<div class="container">
    <form action="/admin/languages/update/<?= $language['id'] ?>" method="post">
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" id="name" value="<?= set_value('name', $language['name']) ?>" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="flag" class="form-control" id="flag" value="<?= set_value('flag', $language['flag']) ?>">
